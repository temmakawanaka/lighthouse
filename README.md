...
「次に訪れる灯台を決める」ための、日本の灯台フィールドガイドです。名称・読み・地域から「のぼれる灯台16」を探し、歴史・諸元・参観条件を確認して、公式案内や地図へ進めます。
...
データ更新方針と確認記録は `docs/data-review-2026-09-09.md`、静的ホスティング構成は `docs/static-hosting.md` を参照してください。
